...
function az_barrio_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['azbs_settings']['settings']['az_bootstrap_style']['heading_font_styles'] = [
    '#title' => t('Use Serif headings'),
    '#type' => 'checkbox',
    '#description' => t("Use the Garamond serif font for headings H1, H2, and H3."),
    '#default_value' => \Drupal::service('Drupal\Core\Extension\ThemeSettingsProvider')->getSetting('heading_font_styles'),
  ];
