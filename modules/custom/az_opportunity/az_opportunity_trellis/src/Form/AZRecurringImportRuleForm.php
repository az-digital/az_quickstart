...
use Drupal\az_opportunity_trellis\Entity\AZRecurringImportRule;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Trellis Opportunity Import form.
 */
final class AZRecurringImportRuleForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state): array {
    ...
    /** @var \Drupal\az_opportunity_trellis\Entity\AZRecurringImportRule $entity */
    $entity = $this->entity;
    ...
    if (!empty($mappings)) {
      ...
      $form['query_parameters']['attributes']['empty'] = [
        '#type' => 'item',
