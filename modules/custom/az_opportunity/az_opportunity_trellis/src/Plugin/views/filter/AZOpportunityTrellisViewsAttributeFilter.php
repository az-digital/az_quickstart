...
/**
 * Filter Trellis opportunity API values according to Enterprise Attributes.
 */
#[ViewsFilter("az_opportunity_trellis_views_attribute_filter")]
class AZOpportunityTrellisViewsAttributeFilter extends FilterPluginBase {
