...
/**
 * Filter Trellis opportunity API values according to approval status.
 */
#[ViewsFilter("az_opportunity_trellis_views_approval_filter")]
class AZOpportunityTrellisViewsApprovalFilter extends FilterPluginBase {
