...
namespace Drupal\az_opportunity_trellis\Plugin\views\filter;
...
/**
 * Filter Trellis opportunity API values according to dates.
 */
#[ViewsFilter("az_opportunity_trellis_views_date_filter")]
class AZOpportunityTrellisViewsDateFilter extends FilterPluginBase {
  ...
  protected function valueForm(&$form, FormStateInterface $form_state): void {
    ...
    $form['#attached']['library'][] = 'az_opportunity_trellis/az_opportunity_trellis_date';
    ...
    try {
      $attached = AttachedAssets::createFromRenderArray([
        '#attached' => [
          'library' => [
            'az_opportunity_trellis/easepick_styles',
          ],
        ],
      ]);
