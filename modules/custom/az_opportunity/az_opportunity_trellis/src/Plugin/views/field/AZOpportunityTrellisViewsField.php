...
namespace Drupal\az_opportunity_trellis\Plugin\views\field;
 ...
 */
#[ViewsField("az_opportunity_trellis_views_field")]
class AZOpportunityTrellisViewsField extends BulkForm {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    $instance->trellisHelper = $container->get('az_opportunity_trellis.trellis_helper');
    return $instance;
  }
  ...
  public function viewsFormSubmit(&$form, FormStateInterface $form_state) {
    ...
    if (!empty($values[$this->options['id']])) {
      ...
      foreach ($ids as $value) {
        if (!empty($value)) {
          \Drupal::service('messenger')->addMessage($this->t('Importing Trellis Opportunity <strong>@id</strong>.', [
            '@id' => $value,
          ]));
        }
      }
