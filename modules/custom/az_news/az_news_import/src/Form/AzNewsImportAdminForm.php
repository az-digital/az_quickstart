...
namespace Drupal\az_news_import\Form;
 ...
 */
class AzNewsImportAdminForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames(): array {
    return [
      'migrate_plus.migration_group.az_news_import',
      'az_news_import.settings',
    ];
  }
