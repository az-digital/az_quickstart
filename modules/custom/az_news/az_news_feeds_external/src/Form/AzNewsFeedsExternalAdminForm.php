...
namespace Drupal\az_news_feeds_external\Form;
 ...
 */
class AzNewsFeedsExternalAdminForm extends ConfigFormBase {
  ...
  /**
   * Constructs a AzNewsFeedsExternalAdminForm object.
   *
  ...
  protected function getEditableConfigNames(): array {
    return [
      'migrate_plus.migration_group.az_news_feeds_external',
      'az_news_feeds_external.settings',
    ];
  }
  ...
  public function getFormId(): string {
    return 'az_news_feeds_external_admin';
  }
  ...
  public function getRemoteTermOptions(): array {
    $az_news_feeds_config = $this->config('az_news_feeds_external.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $az_news_feeds_config = $this->configFactory->getEditable('az_news_feeds_external.settings');
    ...
    $group_config = $this->configFactory->getEditable('migrate_plus.migration_group.az_news_feeds_external');
    $base_uri = $az_news_feeds_config->get('uarizona_news_base_uri');
