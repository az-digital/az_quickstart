...
class AZRankingDefaultFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    if ($parent instanceof ParagraphInterface) {
      ...
      // Legacy version of this flie used `pb-4` to make a gap between
      // rows of rankings. New SDC's use `gap: 1.5rem`, which doesn't fill
      // the last row of rankings in a ranking-deck. So we're putting it
      // here to match
