  ...
  public function buildBehaviorForm(ParagraphInterface $paragraph, array &$form, FormStateInterface $form_state) {
    ...
    $form['text_background_pattern'] = [
      ...
      '#options' => [
        ...
        'bg-monsoon-sky-start' => $this->t('Monsoon Sky Left'),
        'bg-monsoon-sky-end' => $this->t('Monsoon Sky Right'),
        'bg-monsoon-white-start' => $this->t('Monsoon White Left'),
        'bg-monsoon-white-end' => $this->t('Monsoon White Right'),
        'bg-monsoon-warm-gray-start' => $this->t('Monsoon Warm Gray Left'),
        'bg-monsoon-warm-gray-end' => $this->t('Monsoon Warm Gray Right'),
        'bg-monsoon-cool-gray-start' => $this->t('Monsoon Cool Gray Left'),
        'bg-monsoon-cool-gray-end' => $this->t('Monsoon Cool Gray Right'),
      ],
