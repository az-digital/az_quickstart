  ...
  public function buildBehaviorForm(ParagraphInterface $paragraph, array &$form, FormStateInterface $form_state) {
    ...
    $form['text_background_pattern'] = [
      ...
      '#options' => [
        ...
        'bg-monsoon-white-start' => $this->t('Monsoon White Start'),
        'bg-monsoon-white-end' => $this->t('Monsoon White End'),
        'bg-monsoon-warm-gray-start' => $this->t('Monsoon Warm Gray Start'),
        'bg-monsoon-warm-gray-end' => $this->t('Monsoon Warm Gray End'),
        'bg-monsoon-cool-gray-start' => $this->t('Monsoon Cool Gray Start'),
        'bg-monsoon-cool-gray-end' => $this->t('Monsoon Cool Gray End'),
      ],
