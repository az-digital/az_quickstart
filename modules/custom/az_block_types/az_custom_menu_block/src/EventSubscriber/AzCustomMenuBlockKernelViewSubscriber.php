...
namespace Drupal\az_custom_menu_block\EventSubscriber;
 ...
 */
class AzCustomMenuBlockKernelViewSubscriber implements EventSubscriberInterface {
    ...
    switch ($this->currentRouteMatch->getRouteName()) {
      ...
      case 'context.reaction.blocks.library':
        ...
        foreach ($result['blocks']['#rows'] as $key => $row) {
          ...
          if (strpos($plugin_id, 'az_menu_block:') === 0) {
