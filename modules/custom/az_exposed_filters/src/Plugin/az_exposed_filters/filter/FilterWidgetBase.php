...
/**
 * Base class for AZ exposed filters widget plugins.
 */
abstract class FilterWidgetBase extends AzExposedFiltersWidgetBase implements AzExposedFiltersWidgetInterface {
  ...
  public static function isApplicable($filter = NULL, array $filter_options = []) {
    ...
    if (is_a($filter, 'Drupal\taxonomy\Plugin\views\filter\TaxonomyIndexTid')) {
      ...
      // TaxonomyIndexTid, but we can't show AZ Exposed Filters options for the autocomplete
      // widget.
  ...
  public function exposedFormAlter(array &$form, FormStateInterface $form_state) {
    ...
    if ($this->configuration['advanced']['rewrite']['filter_rewrite_values']) {
      ...
      $form[$field_id]['#options'] = AzExposedFiltersHelper::rewriteOptions($form[$field_id]['#options'], $this->configuration['advanced']['rewrite']['filter_rewrite_values'], !$this->configuration['advanced']['sort_options']);
  ...
  public function processSortedOptions(array $element, FormStateInterface $form_state) {
    ...
    if (!empty($element['#nested'])) {
      ...
      $options = AzExposedFiltersHelper::sortNestedOptions($options, $delimiter);
    }
    else {
      $options = AzExposedFiltersHelper::sortOptions($options);
    }
