...
class Sliders extends FilterWidgetBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['animate_ms'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[name="exposed_form_options[az_exposed_filters][filter][' . $filter->field . '][configuration][animate]"]' => ['value' => self::ANIMATE_CUSTOM],
        ],
      ],
    ];
  ...
  public function exposedFormAlter(array &$form, FormStateInterface $form_state) {
    ...
    $form[$field_id]['#attached']['library'][] = 'az_exposed_filters/sliders';

    // Set the slider settings.
    $form[$field_id]['#attached']['drupalSettings']['az_exposed_filters']['slider'] = TRUE;
    $form[$field_id]['#attached']['drupalSettings']['az_exposed_filters']['slider_options'][$field_id] = [
